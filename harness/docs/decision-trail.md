...
- **link**:`docs/decisions/2026-06-13-governance-single-layer.md`

## 2026-06-13 — skip 字段退役(豁免改走 exempt 微 audit 凭证正道)

- **抉择(消制度洞)**:skip 字段退役——豁免改走 exempt 微 audit 凭证正道。对账天然认,消除"reconcile 不认 skip"制度洞。
- **link**:`docs/decisions/2026-06-13-governance-single-layer.md`
