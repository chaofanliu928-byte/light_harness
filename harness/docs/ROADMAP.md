...
- 新增 `docs/references/testing-standard.md`:定义 Evidence Depth L1-L5 的语义(**术语提案,待用户确认**;草案参考 `D:/个人/coding-agent-harness/references/regression-system.md`,但最终语义由用户定)
...
- Evidence Depth L1-L5 语义在 `docs/references/testing-standard.md` 中定义(**术语 SSoT**)
